...
export default function RegisterPage() {
  ...
  const { user, loading, register, loginWithGmail } = useAuth();
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4">
      <div className="w-full max-w-md glass rounded-2xl p-8 text-center">
        ...
        <p className="text-[#A5A8AD] mb-8">Junte-se ao L9Inbox</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-[#A5A8AD] mb-1">
              Nome
            </label>
            <input
              id="name"
        ...
        <p className="mt-6 text-sm text-[#A5A8AD]">
          ...
          <Link href="/login" className="text-[#532E8E] hover:text-[#7B5EA7] font-medium">
            Entrar
          </Link>
        </p>
      </div>
